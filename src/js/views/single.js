...
export const Single = props => {
	...
	return (
		<div className="jumbotron">
			 <img className="card-img-top" key={params.theid} src={'https://starwars-visualguide.com/assets/img/characters/' + ( parseInt(params.theid) + 1) + '.jpg'} onError={({ currentTarget }) => {
